...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const formulario =
            document.getElementById("formularioRegistrarBus");
    ...
    const mensajePlaca =
            document.getElementById("mensajePlaca");
    ...
    function limpiarErrores() {
        ...
        placa.classList.remove("campo-invalido");
    ...
    formulario.addEventListener("submit", function (event) {
        ...
        if (placa.value.trim() === "") {
            ...
            placa.classList.add("campo-invalido");
