...
public class ViajeDAO {
        ...
        try (
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    viaje.setCodigoViaje(rs.getString("codigo_viaje"));
                    viaje.setTipoViaje(rs.getString("tipo_viaje"));
                    viaje.setPlacaBus(rs.getString("placa_bus"));
                    viaje.setNumeroLicencia(rs.getString("numero_licencia"));
                    viaje.setCodigoRuta(rs.getString("codigo_ruta"));
                    viaje.setOrigen(rs.getString("origen"));
                    viaje.setDestino(rs.getString("destino"));
                    viaje.setFechaSalida(rs.getDate("fecha_salida"));
                    viaje.setHoraSalida(rs.getTime("hora_salida"));
                    viaje.setFechaLlegadaEstimada(rs.getDate("fecha_llegada_estimada"));
                    viaje.setHoraLlegadaEstimada(rs.getTime("hora_llegada_estimada"));
                    viaje.setEstado(rs.getString("estado"));
                    viaje.setDepreciacionPorKm(rs.getDouble("depreciacion_por_km"));
                    viaje.setDepreciacionTotal(rs.getDouble("depreciacion_total"));
    ...
    public boolean iniciarViaje(
        ...
        try (Connection conexion = Conexion.getConnection()) {
            ...
            try (
                    ...
                    = conexion.prepareStatement(sqlVerificar); PreparedStatement psSalida
                    = conexion.prepareStatement(sqlSalida); PreparedStatement psViaje
    ...
    public boolean finalizarViaje(
        ...
        double depreciacionPorKm = configuracion.getDepreciacionPorKm();
        String sqlVerificar = """
        SELECT v.placa_bus,
        ...
        try (Connection conexion
            ...
            try (
                    PreparedStatement psVerificar
                    = conexion.prepareStatement(sqlVerificar); PreparedStatement psLlegada
